alter table competition_seeds rename to seeds;
create table competition_seeds as select seeds.competition_id, seeds.id as seed_id from seeds;
alter table competition_seeds add constraint competition_seeds_competition_id_fkey foreign key (competition_id) references competitions(id) on delete cascade;
alter table competition_seeds add constraint competition_seeds_seed_id_fkey foreign key (seed_id) references seeds(id) on delete cascade;
alter table competition_seeds add primary key (competition_id, seed_id);
alter table seeds drop column competition_id cascade;
